...
class Pagination extends Component{
    constructor(props){
        super(props)
        this.state = {
            pageCount: props.tableProps.pageCount,
            pageIndex: props.tableProps.state.pageIndex,
            visiblePages: this.getVisiblePages(null, props.tableProps.pageCount)
        }
    ...
    componentDidMount(){
        this.setState({pageCount: this.props.tableProps.pageCount, pageIndex: this.props.tableProps.state.pageIndex})
     ...
     */
    changePage(page){
        const activePage = this.state.pageIndex + 1;
        ...
        this.setState({visiblePages: this.filterPages(this.state.visiblePages, this.state.pageCount)});

        this.props.tableProps.gotoPage(page - 1);
    }
            ...
            <>
                <div className="d-lg-flex align-items-center text-center pb-1">
                    ...
                    <span className="me-3">
                        Page{' '}
                        <strong>
                            {this.state.pageIndex + 1} of {this.props.tableProps.pageOptions.length}
                        </strong>{' '}
                    </span>
                    ...
                    <span className="d-inline-block align-items-center text-sm-start text-center my-sm-0 my-2">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                this.props.tableProps.gotoPage(page);
                    ...
                    <ul className="pagination pagination-rounded d-inline-flex ms-auto align-item-center mb-0">
                        ...
                        <li
                            ...
                            className={classNames('page-item', 'paginate_button', 'next', {
                                disabled: activePage === this.props.tableProps.pageCount,
                            })}
                            onClick={() => {
                                if (activePage === this.props.tableProps.pageCount) return;
                                this.changePage(activePage + 1);
                            }}
                        >
                            <Link to="#" className="page-link">
